...
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.CAST
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.DSCR
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.EDUC
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.IDNO
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.NATI
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.NCHI
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.NMR
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.OCCU
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.PROP
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.RELI
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.RESI
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.SSN
import io.dontsayboj.spindler.domain.enum.IndividualAttribute.TITL
import io.dontsayboj.spindler.domain.enum.IndividualEvent.ADOP
import io.dontsayboj.spindler.domain.enum.IndividualEvent.BAPM
import io.dontsayboj.spindler.domain.enum.IndividualEvent.BARM
import io.dontsayboj.spindler.domain.enum.IndividualEvent.BASM
import io.dontsayboj.spindler.domain.enum.IndividualEvent.BIRT
import io.dontsayboj.spindler.domain.enum.IndividualEvent.BLES
import io.dontsayboj.spindler.domain.enum.IndividualEvent.BURI
import io.dontsayboj.spindler.domain.enum.IndividualEvent.CENS
import io.dontsayboj.spindler.domain.enum.IndividualEvent.CHR
import io.dontsayboj.spindler.domain.enum.IndividualEvent.CHRA
import io.dontsayboj.spindler.domain.enum.IndividualEvent.CONF
import io.dontsayboj.spindler.domain.enum.IndividualEvent.CREM
import io.dontsayboj.spindler.domain.enum.IndividualEvent.DEAT
import io.dontsayboj.spindler.domain.enum.IndividualEvent.EMIG
import io.dontsayboj.spindler.domain.enum.IndividualEvent.FCOM
import io.dontsayboj.spindler.domain.enum.IndividualEvent.GRAD
import io.dontsayboj.spindler.domain.enum.IndividualEvent.IMMI
import io.dontsayboj.spindler.domain.enum.IndividualEvent.NATU
import io.dontsayboj.spindler.domain.enum.IndividualEvent.ORDN
import io.dontsayboj.spindler.domain.enum.IndividualEvent.PROB
